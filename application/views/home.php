...
<html lang="en">
  <head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="Famella Firdauzy Mogo">
    <!-- Meta Description -->
    <meta name="description" content="Curriculum Vitae Famella">
    <!-- Meta Keyword -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str = "https://wa.me/6285334833807?text=Hallo *Famella*, Saya tertarik dengan CV kamu.";
